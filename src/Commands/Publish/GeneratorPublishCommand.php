...
class GeneratorPublishCommand extends PublishBaseCommand
{
    ...
    {
        $apiVersion = config('infyom_generator.api_version', 'v1');
        $apiPrefix = config('infyom_generator.api_prefix', 'api');
    ...
    private function publishTestCases()
    {
        ...
        $testsPath = config('infyom_generator.path.api_test', base_path('tests/'));
